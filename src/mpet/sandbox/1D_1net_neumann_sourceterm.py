...
class FirstTest(MPET):
    ...
    def exact_solutions(self, t):
        ...
        # p0 = Expression("(13.0 - 13/(L) * x[0])",
        #                  L = L, t = t, domain=self.mesh, degree=3)
...
def single_run():
    ...
    T = 10.0
    # T = 4*dt
    L = 70.0 #is it 50mm a right guess?
    Q = 1.0/(4.5e-10)
    AA = 1
    alphas = (1.0,)
    Ks = (1.573e-5,)
    ...
    # Solve
    filenameu = "results/1D_1Net_Neumann_sourceterm5/u_1D.xdmf"
    filenamep0 = "results/1D_1Net_Neumann_sourceterm5/p0_1D.xdmf"
    filenamep1 = "results/1D_1Net_Neumann_sourceterm5/p1_1D.xdmf"
    filenamevf = "results/1D_1Net_Neumann_sourceterm5/vf_1D.pvd"
