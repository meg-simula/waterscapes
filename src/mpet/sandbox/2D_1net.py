...
class FirstTest(MPET):
    ...
    def boundary_conditions(self, t):
        ...
        # p0 = [((1), Expression("A0*sin(2.0*pi*t)",A0 = 13.0, t=t, domain=self.mesh, degree=3), self.ventricles),]
        u0 = []
        return u0, p0
...
def single_run():
    ...
    foldername = "2D_1Net_PulsatilePressureGradient_Neumann" + "_nullspace = %s" %problem.nullspace() +\
