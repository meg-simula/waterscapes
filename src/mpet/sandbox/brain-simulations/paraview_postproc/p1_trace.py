...
for d in directories:
	try:
		...
		path = root + d + '/pvd/'
		p1pvd = PVDReader(FileName = path + 'p1.pvd')
		arrayname = p1pvd.PointData.GetArray(0).Name
		# get animation scene
		...
		# show data in view
		p1pvdDisplay = Show(p1pvd, renderView1)
		...
		# Properties modified on p1pvdDisplay
		p1pvdDisplay.Opacity = 0.1
		...
		# show color bar/color legend
		p1pvdDisplay.SetScalarBarVisibility(renderView1, True)
		...
		SaveScreenshot(path + "p1_snap.png", renderView1)
	    # set active source
