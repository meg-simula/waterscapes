...
for d in directories:
	try:
		...
		p3pvd = PVDReader(FileName = path + 'p3.pvd')
		arrayname = p3pvd.PointData.GetArray(0).Name
		# get animation scene
		...
		f_623LUT.ApplyPreset('erdc_red2purple_BW', True)
		# invert the transfer function
		f_623LUT.InvertTransferFunction()
		# create a new 'Slice'
		slice1 = Slice(Input=p3pvd)
		...
		# Properties modified on p3pvdDisplay
		p3pvdDisplay.Opacity = 0.1
		...
		# show color bar/color legend
		p3pvdDisplay.SetScalarBarVisibility(renderView1, True)
        ...
        # Data Range
        datarange = p3pvd.PointData.GetArray(0).GetRange()
		f_623LUT.RescaleTransferFunction(datarange[0], datarange[1])
		# update the view to ensure updated data information
		renderView1.Update()
		SaveScreenshot(path + "p3_snap.png", renderView1)
	    # set active source
