...
class FirstTest(MPET):
    ...
    def boundary_conditions(self, t):
        ...
        u0 = [(Expression(("0.0","0.0", "0.0"), domain=self.mesh, degree=5, t=t, L=L), self.allboundary)]
...
def single_run():
    ...
    # # Create solver
    # print "solver..."
    # solver = SimpleSolver(problem, {"dt": dt, "theta":1.0, "T": T, "direct_solver": False, "testing":False, "fieldsplit": False,\
    #                                     "krylov_solver": {"monitor_convergence":True, "nonzero_initial_guess":True,\
    #                                     "relative_tolerance": 1.e-6, "absolute_tolerance": 1.e-10, "divergence_limit": 1.e20}})
    # 
    # # Solve
    ...
    # 
    # 
    # fileu = File("u_brain.pvd")
    # filep0 = File("p0_brain.pvd")
    # filep1 = File("p1_brain.pvd")
    # fileu<<u
    # filep0<<p[0]
    # filep1<<p[1]
